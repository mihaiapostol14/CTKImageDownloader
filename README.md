...
![CTKImageDownloader Preview](https://github.com/mihaiapostol14/CTKImageDownloader/blob/86c177023cacf18044a52c97d0acc0449127178b/assets/preview.png)
...
```bash
git clone https://github.com/mihaiapostol14/CTKImageDownloader.git
cd CTKImageDownloader
```
